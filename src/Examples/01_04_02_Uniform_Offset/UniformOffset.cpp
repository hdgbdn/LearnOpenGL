...
const string APP_NAME = "UniformOffset";
...
int main(int, char**)
{
    ...
    glm::vec3 vertex_offset(0.0f, 0.0f, 0.0f);
	...
	auto renderOp = new LambdaOp([&]()
		{
            ...
            shader.Use();
            shader.set("offset", vertex_offset);
            glBindVertexArray(VAO);
    ...
    auto uiOp = new LambdaOp([&]()
        {
			...
			ImGui::NewFrame();
			{
                ...
                ImGui::SliderFloat3("Vertex Offset", (float *)&vertex_offset, -1.0f, 1.0f);
				ImGui::End();
			}
