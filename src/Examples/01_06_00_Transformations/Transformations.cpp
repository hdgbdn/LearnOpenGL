	...
	auto renderOp = new LambdaOp([&]()
		{
            ...
            trans = glm::rotate(trans, rotiaion_angle, glm::vec3(0.0f, 0.0f, 1.0f));
    ...
    auto uiOp = new LambdaOp([&]()
        {
			...
			ImGui::NewFrame();
			{
                ...
                ImGui::SliderFloat3("transform", (float*)&transform, -1.0f, 1.0f);
                ImGui::SliderFloat("rotiaion_angle", &rotiaion_angle, -3.14f, 3.14f);
				ImGui::End();
			}
