...
const string APP_NAME = "View space";
	...
	window.PushRenderOperation(Operation([&]
		{
			...
			colorShader.set("lightPos", glm::vec3( view * glm::vec4(lightPos, 1.f)));
			colorShader.set("viewPos", glm::vec3(view* glm::vec4(cam.GetPosition(), 1.f)));
