...
const string APP_NAME = "Material";
...
int main(int, char**)
{
	...
	glm::vec3 materialAmbient(1.f, 1.f, 1.f);
	glm::vec3 materialDiffuse(1.f, 1.f, 1.f);
	glm::vec3 materialSepcular(1.f, 1.f, 1.f);
	...
	window.PushRenderOperation(Operation([&]
		{
			...
			colorShader.set("material.ambient", materialAmbient);
			colorShader.set("material.diffuse", materialDiffuse);
			colorShader.set("material.specular", materialSepcular);
			...
			ImGui::NewFrame();
			{
				...
				ImGui::ColorEdit3("Material specular", (float*)&materialSepcular);
