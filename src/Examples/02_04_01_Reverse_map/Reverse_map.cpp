...
const string APP_NAME = "Light map";
...
int main(int, char**)
{
	...
	Texture texSpecular = Texture((tex_path / "container2.png").string());
	Texture texDiffuse = Texture((tex_path / "container2_specular.png").string());
